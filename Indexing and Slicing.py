...
# Slicing is similar to indexing, but instead you are retrieving just one value, you are retrieving a whole sub-section of the string. 
...
print(mystring[::2]) # This will just present the string, but in interals of 2 from the beginning. 
